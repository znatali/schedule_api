...
class Common(Configuration):
    ...
    INSTALLED_APPS: Tuple[str, ...] = (
        ...
        # Third party apps   # TODO install and setup
    ...
    SECRET_KEY = '__CHANGEME__'     # TODO use .env
    ...
    ADMINS = (
        ('Author', 'idigitalbrick@gmail.com'),
    )
    ...
    DB_TOOLS_URL_PREFIX = 'pt'  # using in secret backup/restore url paths
